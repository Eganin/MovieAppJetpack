...
import com.eganin.jetpack.thebest.movieapp.ui.presentation.views.theme.AdultColor
...
fun CalendarView(
    ...
    /*
    вешаем слушателя, чтобы в ON_START запрашивать permission у пользователя
     */
                        ...
                        Manifest.permission.WRITE_CALENDAR -> {
                            when {
                                ...
                                perm.isPermanentlyDenied() -> {
                                    /*
                                    при рекомпоузе показваем AlertDialog
                                    и сохраняем туда текст и тип действия для запуска
                                    activity settings
                                     */
                                    showAlertDialog.value = !showAlertDialog.value
                                    textMessageAlertDialog.value =
